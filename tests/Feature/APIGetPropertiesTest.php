 ...
 */
it('returns valid JSON data of Properties for an authenticated user', function () {

    TestCounter::$count++;
    dump(sprintf('Test %03d - Testing it returns valid JSON data of Properties for an authenticated user', TestCounter::$count));
